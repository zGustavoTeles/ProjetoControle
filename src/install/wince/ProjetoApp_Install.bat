...
:ok
"%ProgramFiles%\Microsoft ActiveSync\CeAppMgr.exe" ".\ProjetoApp_Install.ini"
if "%errorlevel%"=="1" goto end

"%windir%\WindowsMobile\CeAppMgr.exe" ".\ProjetoApp_Install.ini"
if "%errorlevel%"=="1" goto end

CeAppMgr.exe ".\ProjetoApp_Install.ini"
